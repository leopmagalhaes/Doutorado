...
I = cv2.imread("Infra3112_2019.tif").astype(np.float)
I = I[y:y+h, x:x+w]
R = cv2.imread("Vermelho3112_2019.tif").astype(np.float)
R = R[y:y+h, x:x+w]
G = cv2.imread("Verde3112_2019.tif").astype(np.float)
G = G[y:y+h, x:x+w]
B = cv2.imread("Azul3112_2019.tif").astype(np.float)
B = B[y:y+h, x:x+w]
I = I[:, :, 0]
R= R[:, :, 0]
G= G[:, :, 0]
...
with np.errstate(invalid='ignore'):
    ...
    NDVIc = 0.8841 - (0.0131*R) + (0.0023*G) + (0.0018*B)
...
min1 = NDVI[np.isfinite(NDVI)].min()
max1 = NDVI[np.isfinite(NDVI)].max() 
print('Maximo =', max1)
print('Minimo =', min1)
print('NDVI =', NDVI[np.isfinite(NDVI)].mean())
...
print('Maximo =', max1)
print('Minimo =', min1)
print('NDVIc =', NDVIc[np.isfinite(NDVIc)].mean())
plt.clim(min1, max1)
plt.colorbar()
plt.axis('off')
plt.title('NDVIc')
...
print('Maximo =', max2)
print('Minimo =', min2)
print('ExG =', ExG[np.isfinite(ExG)].mean())
plt.clim(min2, max2)
plt.colorbar()
plt.axis('off')
plt.title('ExG')
...
print('Maximo =', max3)
print('Minimo =', min3)
print('ExGR =', ExGR[np.isfinite(ExGR)].mean())
plt.clim(min3, max3)
plt.colorbar()
plt.axis('off')
plt.title('ExGR')
...
print('Maximo =', max4)
print('Minimo =', min4)
print('VEG =', VEG[np.isfinite(VEG)].mean()) 
plt.clim(min4, max4)
plt.colorbar()
plt.axis('off')
plt.title('VEG')
...
print('Maximo =', max5)
print('Minimo =', min5)
print('CIVE =', CIVE[np.isfinite(CIVE)].mean())
plt.clim(min5, max5)
plt.colorbar()
plt.axis('off')
plt.title('CIVE')
...
print('Maximo =', max6)
print('Minimo =', min6)
print('COM =', COM[np.isfinite(COM)].mean())
plt.clim(min6, max6)
plt.colorbar()
plt.axis('off')
plt.title('COM')
...
print('Maximo =', max7)
print('Minimo =', min7)
print('RGBVI =', RGBVI[np.isfinite(RGBVI)].mean())
plt.clim(min7, max7)
plt.colorbar()
plt.axis('off')
plt.title('RGBVI')
...
print('Maximo =', max8)
print('Minimo =', min8)
print('GLI =', GLI[np.isfinite(GLI)].mean())
plt.clim(min8, max8)
plt.colorbar()
plt.axis('off')
plt.title('GLI')
...
print('Maximo =', max9)
print('Minimo =', min9)
print('VARI =', VARI[np.isfinite(VARI)].mean())
plt.clim(min9, max9)
plt.colorbar()
plt.axis('off')
plt.title('VARI')
...
print('Maximo =', max11)
print('Minimo =', min11)
print('TGI =', TGI[np.isfinite(TGI)].mean())
...
print('Maximo =', max12)
print('Minimo =', min12)
print('RGVBI =', RGVBI[np.isfinite(RGVBI)].mean())
...
print('Maximo =', max13)
print('Minimo =', min13)
print('MGVRI =', MGVRI[np.isfinite(MGVRI)].mean())
